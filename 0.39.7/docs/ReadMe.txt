...
E) Own classes and manpages and scripts
########################################
...
1) Put the oobash file, that you generated by the Class.generator tool
to oobash/src/myClassFiles/
2) Put the array definition in your new file to the other array definitions in the 
oobash.source file
3) use the import function in the oobash.source file:
...
If you want to make your man for the class
...
Example:
Class.generator Person name age >Person.oobash
source Person.oobash
...
4) Use the pod2man command to create the manpage for your new script.
   The skeleton gives you the details,how to use the pod2man.
Example:
